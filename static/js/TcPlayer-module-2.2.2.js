!function (e, t) {
  ...
  return function (e) {
    ...
    function l(e) {
      var t = {
        urls: {
          m3u8: {od: e.m3u8 || "", hd: e.m3u8_hd || "", sd: e.m3u8_sd || ""},
          flv: {od: e.flv || "", hd: e.flv_hd || "", sd: e.flv_sd || ""},
          mp4: {od: e.mp4 || "", hd: e.mp4_hd || "", sd: e.mp4_sd || ""},
          rtmp: {od: e.rtmp || "", hd: e.rtmp_hd || "", sd: e.rtmp_sd || ""}
    ...
    function c(e, t, i) {
      var o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : w, n = "", r = void 0;
      i = i || (d.IS_MOBILE ? o.mobile : o.pc);
      for (var s = 0; s < i.length; s++) if (n = i[s], e[n][t]) {
        r = {definition: t, url: e[n][t], format: n};
        break
      }
      return r
    }
    ...
    var h = i(1), d = o(h), f = i(2), y = (o(f), i(3)), v = o(y), m = i(4), b = o(m), g = i(5), _ = b.MSG,
      w = {mobile: ["m3u8", "mp4"], pc: ["rtmp", "flv", "m3u8", "mp4"]}, S = ["od", "hd", "sd"];
    t.TcPlayer = function (e) {
      ...
      return s(t, e), t.prototype._switchClarity = function (e) {
        ...
        var r = v.bind(this, function () {
          parseInt(this.duration() - t) > 0 && !this.options.live && this.currentTime(t), n && this.play(!0), b.unsub(_.MetaLoaded, "*", r, this)
        });
    ...
    function d(e, t, i) {
      var o = arguments.length > 3 && void 0 !== arguments[3] && arguments[3], n = document.createElement("script");
    ...
    function f() {
      var e = document, t = e.documentElement, i = e.body;
      return {
    ...
    function a(e) {
      e = 0 | e;
      var t = 3600, i = 60, o = e / t | 0, n = (e - o * t) / i | 0, r = e - o * t - n * i;
    ...
    function l(e) {
      p.__isFullscreen = !!document[E.fullscreenElement], p.__isFullscreen || b.off(document, E.fullscreenchange, l), _.pub({
        type: g.MSG.FullScreen,
        src: "util",
        ts: e.timeStamp,
        detail: {isFullscreen: p.__isFullscreen}
      }, p.player)
    }

    function c(e, t) {
      b.off(t.video.el, "webkitbeginfullscreen", c), "webkitbeginfullscreen" == e.type ? (b.on(t.video.el, "webkitendfullscreen", function (e) {
        c(e, t)
      }), _.pub({
        type: g.MSG.FullScreen,
        src: "util",
        ts: e.timeStamp,
        detail: {isFullscreen: !0}
      }, p.player)) : "webkitendfullscreen" == e.type && (b.off(t.video.el, "webkitendfullscreen", c), _.pub({
        type: g.MSG.FullScreen,
        src: "util",
        ts: e.timeStamp,
        detail: {isFullscreen: !1}
      }, p.player))
    }
    ...
    function p(e, t, i) {
      ...
      p.player = e, E.requestFullscreen ? t ? (b.on(document, E.fullscreenchange, l), i && i[E.requestFullscreen]()) : document[E.exitFullscreen]() : o && e.video.el.webkitEnterFullScreen ? (b.on(e.video.el, "webkitbeginfullscreen", function (t) {
        c(t, e)
    ...
    t.__esModule = !0, t.supportStyle = t.console = t.VideoType = t.CDNPath = t.FullscreenApi = void 0, t.guid = n, t.bind = r, t.isEmpty = s, t.convertTime = a, t.doFullscreen = p, t.extend = h, t.store = d, t.compareVersion = f, t.escapeHTML = y, t.getFormat = v;
    ...
    t.CDNPath = "//imgcache.qq.com/open/qcloud/video/vcplayer/", t.VideoType = {
      ...
      var e = document.createElement("div"), t = "Khtml O Moz Webkit".split(" "), i = t.length;
      return function (o) {
    ...
    var s = i(1), a = n(s), l = i(2), c = n(l), u = i(3), p = n(u), h = i(4), d = n(h), f = i(10), y = o(f), v = i(13),
      m = o(v), b = i(14), g = o(b), _ = i(22), w = o(_), S = i(23), E = o(S), M = i(24), O = o(M), k = i(25), P = o(k),
      I = i(26), T = o(I);
    ...
    var C = t.MSG = d.MSG, L = t.browser = a, x = t.util = p, F = t.dom = c;
    t.Player = function () {
      function e(t) {
      ...
      return e.prototype.render = function (e) {
        ...
        this.poster = new E["default"](this), this.poster.render(this.el), (L.IS_SAFARI && parseInt(L.SAFARI_VERSION) > 10 || L.IOS_VERSION > 10) && "system" == this.options.controls || (this.bigplay = new w["default"](this), this.bigplay.render(this.el));
        var n = void 0;
        ...
        return L.IE_VERSION && x.compareVersion(L.IE_VERSION, "8.0") == -1 ? (this.errortips.show({code: 5}), !1) : L.IS_FILE_PROTOCOL ? (this.errortips.show({code: 10}), !1) : !!this.options.src || (this.options.videoSource.hasUrl() ? L.IS_IE || !L.IS_ENABLED_FLASH ? this.errortips.show({code: 5}) : this.errortips.show({code: 5}) : this.errortips.show({code: 12}), !1)
      }, e.prototype.size = function (e, t, i) {
        i = i || "cover";
        var o = /^\d+\.?\d{0,2}%$/, n = void 0, r = void 0;
        ...
        switch (e.type) {
          ...
          case C.Play:
            ...
            !this.hasPlay && this.options.flash && (this.mtaReport.reportFlash(), this.hasPlay = !0), F.addClass(this.el, "vcp-playing"), this.video.type() == x.VideoType.RTMP && (this.__wait = !0, this.loading.show()), F.on(this.el, "mousemove", this.__handleEvent);
            break;
          case C.Playing:
            this.loading.hide();
            break;
          case C.TimeUpdate:
            ...
            break;
          case C.Pause:
            F.off(this.el, "mousemove", this.__handleEvent), F.removeClass(this.el, "vcp-playing");
            break;
          case C.Ended:
            F.off(this.el, "mousemove", this.__handleEvent), this.panel && this.panel.show(), F.removeClass(this.el, "vcp-playing");
            break;
          case C.MetaLoaded:
          ...
          case C.Error:
            ...
            try {
              var i = this.options.videoSource, o = x.getFormat(i);
              L.IS_X5TBS ? MtaH5.clickStat("x5_err", {format: o}) : MtaH5.clickStat("error", {format: o})
            } catch (n) {
            }
        }
    ...
    function n(e) {
      for (var t = [], i = {}, o = 0; o < e.length; o++) {
        var n = e[o], r = n[0], s = n[1], a = n[2], l = n[3], c = {css: s, media: a, sourceMap: l};
        i[r] ? i[r].parts.push(c) : t.push(i[r] = {id: r, parts: [c]})
      }
      return t
    }

    function r(e, t) {
      var i = v(), o = g[g.length - 1];
    ...
    function c(e, t) {
      ...
      if (t.singleton) {
        var r = b++;
        i = m || (m = a(t)), o = u.bind(null, i, r, !1), n = u.bind(null, i, r, !0)
    ...
    function u(e, t, i, o) {
      var n = i ? "" : o.css;
      if (e.styleSheet) e.styleSheet.cssText = _(t, n); else {
        var r = document.createTextNode(n), s = e.childNodes;
    ...
    function h(e, t) {
      var i = t.css, o = t.sourceMap;
      o && (i += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(o)))) + " */");
      var n = new Blob([i], {type: "text/css"}), r = e.href;
    ...
    var l = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
      ...
      }, c = i(11), u = n(c), p = i(2), h = o(p), d = i(3), f = o(d), y = i(4), v = i(12), m = o(v), b = i(1), g = o(b),
      _ = (f.FullscreenApi, {
        "0.7.1": "libs/hls.js",
        ...
        return a(t, e), t.prototype.render = function (t) {
          ...
          var t = new Hls({autoStartLoad: !!this.options.hls_autostartload});
          ...
          var t = flvjs.createPlayer({type: "flv", isLive: this.player.options.live, url: e});
          ...
          if (!g.IS_ENABLED_MSE || !i && !o || g.IS_X5TBS && this.player.options.x5_player || i && g.IS_MAC && g.IS_SAFARI && !g.IS_IOS) this.__type = t, this.el.src = e; else {
            var n = this, r = _[this.options.hls] || _["0.7.1"];
    ...
    t.__esModule = !0;
    var a = i(2), l = o(a), c = i(3), u = o(c), p = i(4), h = o(p), d = i(1), f = o(d), y = function () {
      function e(t, i) {
      ...
      return e.prototype.createEl = function (e, t, i) {
        ...
        var o = s(this.guid, i), n = !o, a = o && !this.fnCache[o];
    ...
    "use strict";
    t.__esModule = !0;
    t.PlayStates = {IDLE: "IDLE", PLAYING: "PLAYING", PAUSED: "PAUSED", STOP: "STOP"}, t.SeekStates = {
      IDLE: "IDLE",
      SEEKING: "SEEKING",
      SEEKED: "SEEKED"
    }, t.ControlsStates = {DEFAULT: "default", NONE: "none", SYSTEM: ""}
  }, function (e, t, i) {
    "use strict";
    ...
    t.__esModule = !0;
    var c = i(11), u = n(c), p = i(4), h = i(2), d = o(h), f = i(3), y = o(f), v = i(12), m = o(v), b = i(1), g = o(b),
      _ = function (e) {
        function t(i) {
          r(this, t);
        ...
        return a(t, e), t.prototype.render = function (e) {
          ...
          var t = this.player.options,
            i = t.flashUrl || "//imgcache.qq.com/open/qcloud/video/player/release/QCPlayer.swf", o = "opaque",
            n = "obj_vcplayer_" + this.player.guid, r = this.__flashCB;
          this.__id = n;
          ...
          try {
            switch (this.options.debug && this.pub({
              ...
              case"seekState":
                ...
                if (t.seekState == m.SeekStates.SEEKING) i.type = p.MSG.Seeking; else {
                  if (t.seekState != m.SeekStates.SEEKED) return;
                  this.__m3u8 || this.options.live || t.playState != m.PlayStates.STOP || (this.play(), this.__prevPlayState = t.playState), this.__m3u8 && (i.type = p.MSG.Seeked)
                }
                break;
              case"netStatus":
                this.options.live || ("NetStream.Buffer.Full" == t.code ? (this.__prevPlayState == m.PlayStates.PAUSED || this.__prevPlayState == m.PlayStates.STOP, this.__prevPlayState = null, i.type = p.MSG.Seeked) : "NetStream.Seek.Complete" == t.code), "NetConnection.Connect.Closed" == t.code && (this.options.src.indexOf("rtmp://") > -1 ? this.playState == m.PlayStates.STOP ? (i.type = "error", t = {
                  ...
                  code: 1002,
                  reason: t.code
                }) : this.playState = m.PlayStates.IDLE), "NetStream.Play.Stop" != t.code && "NetConnection.Connect.Success" != t.code && "NetConnection.Connect.Failed" != t.code || (this.playState = m.PlayStates.IDLE);
                break;
              case"mediaTime":
    ...
    t.__esModule = !0;
    var l = i(11), c = n(l), u = i(15), p = n(u), h = i(16), d = n(h), f = i(17), y = i(18), v = n(y), m = i(19),
      b = n(m), g = i(20), _ = n(g), w = i(21), S = n(w), E = i(4), M = i(2), O = o(M), k = i(3), P = o(k), I = i(1),
      T = o(I), C = function (e) {
        function t(i) {
    ...
    t.__esModule = !0;
    var l = i(11), c = n(l), u = i(2), p = (o(u), i(4)), h = (o(p), i(3)), d = (o(h), i(12)), f = (o(d), function (e) {
      function t(i) {
        return r(this, t), s(this, e.call(this, i, "PlayToggle"))
      }

      return a(t, e), t.prototype.render = function (t) {
        return this.createEl("div", {"class": "vcp-playtoggle"}), e.prototype.render.call(this, t)
      }, t.prototype.setup = function () {
    ...
    t.__esModule = !0;
    var l = i(11), c = n(l), u = i(2), p = (o(u), i(4)), h = (o(p), i(3)), d = o(h), f = function (e) {
      function t(i) {
        return r(this, t), s(this, e.call(this, i, "FullscreenToggle"))
      }

      return a(t, e), t.prototype.render = function (t) {
        return this.createEl("div", {"class": "vcp-fullscreen-toggle"}), window.fsApi = d.FullscreenApi, e.prototype.render.call(this, t)
      }, t.prototype.setup = function () {
        this.on("click", this.onClick)
      }, t.prototype.onClick = function () {
    ...
    var l = i(11), c = n(l), u = i(2), p = o(u), h = i(4), d = (o(h), i(3)),
    ...
    t.__esModule = !0;
    var l = i(17), c = n(l), u = i(11), p = n(u), h = i(2), d = (o(h), i(3)), f = o(d), y = function (e) {
      function t(i) {
        return r(this, t), s(this, e.call(this, i, "Timeline"))
      }

      return a(t, e), t.prototype.render = function (t) {
        return this.enabled = !this.options.live, this.createEl("div", {"class": "vcp-timeline"}), this.progress = new c["default"](this.player, (!1)), this.progress.render(this.el, this.enabled), this.track = this.progress.track, this.enabled || (this.el.style.display = "none"), e.prototype.render.call(this, t)
      }, t.prototype.setup = function () {
    ...
    t.__esModule = !0;
    var l = i(17), c = (n(l), i(11)), u = n(c), p = i(2), h = (o(p), i(3)), d = o(h), f = function (e) {
      function t(i) {
        return r(this, t), s(this, e.call(this, i, "Timelabel"))
      }

      return a(t, e), t.prototype.render = function (t) {
        return this.createEl("span", {"class": "vcp-timelabel"}), e.prototype.render.call(this, t)
      }, t.prototype.setup = function () {
    ...
    t.__esModule = !0;
    var l = i(17), c = n(l), u = i(11), p = n(u), h = i(2), d = o(h), f = i(3), y = o(f), v = i(4), m = function (e) {
      function t(i) {
        return r(this, t), s(this, e.call(this, i, "Volume"))
      }

      return a(t, e), t.prototype.render = function (t) {
        return this.createEl("div", {"class": "vcp-volume"}), this.bg = d.createEl("div", {"class": "vcp-volume-bg"}), this.el.appendChild(this.bg), this.volume = new c["default"](this.player, (!0)), this.volume.render(this.el), this.track = this.volume.track, this.icon = d.createEl("span", {"class": "vcp-volume-icon"}), this.el.appendChild(this.icon), e.prototype.render.call(this, t)
      }, t.prototype.setup = function () {
    ...
    t.__esModule = !0;
    var l = i(11), c = n(l), u = i(2), p = o(u), h = i(3), d = o(h), f = {od: "超清", hd: "高清", sd: "标清"},
      y = function (e) {
        function t(i) {
          r(this, t);
    ...
    t.__esModule = !0;
    var l = i(11), c = n(l), u = i(1), p = o(u), h = function (e) {
      function t(i) {
        return r(this, t), s(this, e.call(this, i, "BigPlay"))
      }

      return a(t, e), t.prototype.render = function (t) {
        return this.createEl("div", {"class": "vcp-bigplay"}), e.prototype.render.call(this, t)
      }, t.prototype.setup = function () {
        this.on("click", this.onClick)
      }, t.prototype.onClick = function () {
    ...
    var l = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
      ...
      return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
    }, c = i(11), u = n(c), p = i(2), h = o(p), d = i(3), f = o(d), y = i(1), v = o(y), m = i(4), b = function (e) {
      function t(i) {
        r(this, t);
        var o = s(this, e.call(this, i, "Poster"));
        return o.options.poster && "object" == l(o.options.poster) ? o.poster = o.options.poster : "string" == typeof o.options.poster ? o.poster = {src: o.options.poster} : o.poster = {}, o
      }

      return a(t, e), t.prototype.render = function (t) {
        this.createEl("div", {"class": "vcp-poster"}), this.hide();
        var i = this.poster;
        if (i) {
          this.pic = h.createEl("img", {"class": "vcp-poster-pic"});
    ...
    t.__esModule = !0;
    var l = i(11), c = n(l), u = i(2), p = (o(u), i(4)), h = (o(p), i(3)), d = (o(h), function (e) {
      function t(i) {
        r(this, t);
      ...
      return a(t, e), t.prototype.render = function (t) {
        return this.createEl("div", {"class": "vcp-loading"}), e.prototype.render.call(this, t)
      }, t.prototype.setup = function () {
      }, t.prototype.handleMsg = function (e) {
      }, t.prototype.show = function () {
    ...
    t.__esModule = !0;
    var l = i(11), c = n(l), u = i(2), p = (o(u), i(4)), h = (o(p), i(3)), d = o(h), f = {
      ...
      return a(t, e), t.prototype.render = function (t) {
        return this.createEl("div", {"class": "vcp-error-tips"}), e.prototype.render.call(this, t)
      }, t.prototype.setup = function () {
      }, t.prototype.handleMsg = function (e) {
    ...
    t.__esModule = !0;
    var r = i(1), s = o(r), a = i(2), l = o(a), c = i(3), u = function () {
      function e(t, i) {
      ...
      return e.prototype.load = function () {
        ...
        window.MtaH5 && (0 == this.player.duration() || this.player.duration() == 1 / 0 ? MtaH5.clickStat("live", {live: "true"}) : MtaH5.clickStat("vod", {vod: "true"}))
